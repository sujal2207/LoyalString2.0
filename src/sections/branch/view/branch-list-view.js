...
const TABLE_HEAD = [
  ...
  { id: 'BranchType', label: 'Branch Type', width: 180 },
  { id: 'BranchHead', label: 'Branch Head', width: 220 },
  { id: 'MobileNumber ', label: 'Mobile Number ', width: 180 },
  { id: 'BranchStatus', label: 'Branch Status', width: 180 },
  { id: '', width: 88 },
];
...
export default function BranchListView() {
  ...
  const handleDeleteRows = useCallback(() => {
    const deleteRows = branch.filter((row) => table.selected.includes(row._id));
