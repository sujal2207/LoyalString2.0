...
import { CollectionEditView } from './index';
...
export default function CollectionListView() {
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.collection.edit(id));
    },
    [router],
  );
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Collection', href: paths.dashboard.collection.list },
            { name: 'List' },
          ]}
          action={
            <Button
              component={RouterLink}
              href={paths.dashboard.collection.new}
              variant='contained'
