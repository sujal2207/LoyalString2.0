...
import DevicesTableToolbar from '../devices-table-toolbar';
import DevicesTableFiltersResult from '../devices-table-filters-result';
import { DevicesEditView } from './index';
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Devices', href: paths.dashboard.devices.list },
            { name: 'List' },
          ]}
          action={
            <Button
              component={RouterLink}
              href={paths.dashboard.devices.new}
              variant='contained'
